...
import net.tatans.coeus.bitmap.core.BitmapCache;
import net.tatans.coeus.bitmap.core.BitmapDisplayConfig;
import net.tatans.coeus.bitmap.core.BitmapProcess;
import net.tatans.coeus.bitmap.display.Displayer;
import net.tatans.coeus.bitmap.display.SimpleDisplayer;
import net.tatans.coeus.bitmap.download.Downloader;
...
public class TatansBitmap {
	 ...
	 * @param bitmap
	 */
	public TatansBitmap configLoadingImage(Bitmap bitmap) {
	 ...
	 * @param bitmap
	 */
	public TatansBitmap configLoadingImage(int resId) {
	 ...
	 * @param bitmap
	 */
	public TatansBitmap configLoadfailImage(Bitmap bitmap) {
	 ...
	 * @param resId
	 */
	public TatansBitmap configLoadfailImage(int resId) {
	 ...
	 * @param bitmapHeight
	 */
	public TatansBitmap configBitmapMaxHeight(int bitmapHeight){
	 ...
	 * @param bitmapHeight
	 */
	public TatansBitmap configBitmapMaxWidth(int bitmapWidth){
	 ...
	 * @return
	 */
	public TatansBitmap configDownlader(Downloader downlader){
	 ...
	 * @return
	 */
	public TatansBitmap configDisplayer(Displayer displayer){
	 ...
	 * @return
	 */
	public TatansBitmap configDiskCachePath(String strPath){
	 ...
	 * @param size 缓存大小
	 */
	public TatansBitmap configMemoryCacheSize(int size){
	 ...
	 */
	public TatansBitmap configMemoryCachePercent(float percent){
	 ...
	 * @param size
	 */
	public TatansBitmap configDiskCacheSize(int size){
	 ...
	 * @param size
	 */
	public TatansBitmap configBitmapLoadThreadSize(int size){
		if(size >= 1)
	 ...
	 * @return
	 */
	public TatansBitmap configRecycleImmediately(boolean recycleImmediately){
