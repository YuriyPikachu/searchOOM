...
import net.tatans.coeus.annotation.sqlite.ManyToOne;
import net.tatans.coeus.annotation.sqlite.OneToMany;
import net.tatans.coeus.annotation.sqlite.Property;
import net.tatans.coeus.annotation.sqlite.Transient;
