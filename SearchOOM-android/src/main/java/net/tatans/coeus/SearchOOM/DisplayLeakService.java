...
import static net.tatans.coeus.SearchOOM.internal.LeakCanaryInternals.classSimpleName;
import static net.tatans.coeus.SearchOOM.internal.LeakCanaryInternals.showNotification;
...
public class DisplayLeakService extends AbstractAnalysisResultService {
  ...
  @Override protected final void onHeapAnalyzed(HeapDump heapDump, AnalysisResult result) {
    String leakInfo = TatansSearchOOM.leakInfo(this, heapDump, result, true);
